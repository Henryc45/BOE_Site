...
const zipCode = req.body.zipcode;
      ...
      members: [
        {
          ...
          merge_fields: {
            ...
            STATE: state,
            ZIPCODE: zipCode,
            DATEADDED: new Date().toLocaleDateString('en-us', { weekday:"long", year:"numeric", month:"short", day:"numeric"})
        }
      }
    ]
  };
  ...
  const options = {
    method: "POST",
    auth: "henryc:70cedfe5133abb9c55925c001b047f97-us21"
  }
...
app.post("/guidesignup", async (req, res) => {
  try {
    const user = await req.app.get("user");
    let userId;
    if (user) {
